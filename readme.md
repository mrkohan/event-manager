...
### Upload the Plugin
1. Upload the `event-manager` folder to the `/wp-content/plugins/` directory.

### Activate the Plugin
1. Navigate to the Plugins page in the WordPress admin area and activate the Event Manager plugin.
...
### Creating Events
1. Navigate to **Events > Add New** in the WordPress admin dashboard.
2. Enter the event details, including title, content, event date, and location.
3. Assign an Event Type from the available options or create a new one.
4. Publish the event to make it live on your site.
